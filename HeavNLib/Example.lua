...
-- Settings_ShowKeybinds lives in Toggles (built-in tab attaches deferred)
task.defer(function()
	if Toggles.Settings_ShowKeybinds then
		Toggles.Settings_ShowKeybinds:OnChanged(function()
			Library.KeybindFrame.Visible = Toggles.Settings_ShowKeybinds.Value
		end)
	end
end)
