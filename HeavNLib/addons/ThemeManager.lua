...
local ThemeManager = {} do
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		local function addColor(label, field)
			local picker = groupbox:AddLabel(label):AddColorPicker(field, { Default = self.Library[field] })
		...
		groupbox:AddDivider()
		local themeList = groupbox:AddDropdown('ThemeManager_ThemeList', { Text = 'Theme list', Values = ThemesArray, Default = 1 })
		...
		groupbox:AddDivider()
		local customName = groupbox:AddInput('ThemeManager_CustomThemeName', { Text = 'Custom theme name' })
		local customList = groupbox:AddDropdown('ThemeManager_CustomThemeList', { Text = 'Custom themes', Values = self:ReloadCustomThemes(), AllowNull = true, Default = 1 })
		groupbox:AddDivider()
		...
		groupbox:AddButton('Save theme', function()
			...
			self:ApplyTheme(customList.Value)
		end)
