...
local ThemeManager = {} do
	...
	function ThemeManager:ApplyTheme(theme)
		...
		-- Font (defaults to GothamBold if theme has none)
		...
		-- Background image — built-in themes (or themes without bg meta) reset to OFF
		...
		-- GUI size (only custom themes store this)
	...
	function ThemeManager:CreateThemeManager(groupbox, saveBox)
		self._colorPickers = {}
		-- The theme save/load controls go in their own groupbox when provided
	...
	function ThemeManager:SaveCustomTheme(file)
		...
		-- Save font + background image + layout options as part of the theme
		...
		-- Save the current GUI size so loading the theme restores it
