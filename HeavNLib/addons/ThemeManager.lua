...
local ThemeManager = {} do
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddLabel('Section color'):AddColorPicker('SectionColor', { Default = self.Library.SectionColor })
		groupbox:AddLabel('Accent color'):AddColorPicker('AccentColor', { Default = self.Library.AccentColor })
		groupbox:AddLabel('Outline color'):AddColorPicker('OutlineColor', { Default = self.Library.OutlineColor })
		groupbox:AddLabel('Font color'):AddColorPicker('FontColor', { Default = self.Library.FontColor })
		groupbox:AddLabel('Slider color'):AddColorPicker('SliderColor', { Default = self.Library.SliderColor })
		groupbox:AddLabel('Dropdown color'):AddColorPicker('DropdownColor', { Default = self.Library.DropdownColor })
		groupbox:AddLabel('Button color'):AddColorPicker('ButtonColor', { Default = self.Library.ButtonColor })
		groupbox:AddLabel('Toggle on'):AddColorPicker('ToggleOnColor', { Default = self.Library.ToggleOnColor })
		groupbox:AddLabel('Toggle off'):AddColorPicker('ToggleOffColor', { Default = self.Library.ToggleOffColor })
		groupbox:AddLabel('Keybind active'):AddColorPicker('UIKeybindTextActiveColor', { Default = self.Library.UIKeybindTextActiveColor })
		groupbox:AddLabel('Keybind inactive'):AddColorPicker('UIKeybindTextInactiveColor', { Default = self.Library.UIKeybindTextInactiveColor })
	...
	function ThemeManager:GetIgnoreIndexes()
		local out = { 'ThemeManager_ThemeList', 'ThemeManager_CustomThemeList', 'ThemeManager_CustomThemeName' }
		for _, field in next, self.ColorFields do
