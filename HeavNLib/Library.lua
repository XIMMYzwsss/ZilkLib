...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        function KeyPicker:Update()
            ...
            local frameHeight = math.max(YSize + 36, 60)
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        function Slider:Display()
            ...
            elseif Info.HideMax then
                ...
                text = string.format('%s: %s/%s', Info.Text, Slider.Value .. Suffix, Slider.Max .. Suffix);
            end
...
function Library:Notify(Text, Time)
    ...
    task.spawn(function()
        wait(Time or 8);  -- Default 8 seconds (was 5)
...
function Library:CreateWindow(...)
    ...
    local TabArea = Library:Create('Frame', {
        ...
        Size = UDim2.new(0, 100, 1, -TAB_TOP);
        ZIndex = 2;
        Parent = Inner;
    });
    ...
    local TabContainer = Library:Create('Frame', {
        BackgroundTransparency = 1;
        Position = UDim2.new(0, 105, 0, TAB_TOP);
        Size = UDim2.new(1, -110, 1, -(TAB_TOP + 10));
        ZIndex = 2;
        Parent = Inner;
    });
