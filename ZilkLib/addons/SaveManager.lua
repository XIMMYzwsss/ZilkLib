...
local SaveManager = {} do
	...
	function SaveManager:Confirm(title, message, onConfirm)
		...
		panel.BackgroundColor3 = self.Library.MainColor
		panel.BorderColor3 = self.Library.OutlineColor
		...
		accent.BackgroundColor3 = self.Library.AccentColor
		...
		cancel.BackgroundColor3 = self.Library.MainColor
		cancel.BorderColor3 = self.Library.OutlineColor
		...
		cancel.ZIndex = 200004
		local ok = Instance.new('TextButton', row)
		ok.Size = UDim2.new(0.48, 0, 1, 0)
		ok.Position = UDim2.new(0.52, 0, 0, 0)
		ok.BackgroundColor3 = self.Library.MainColor
		ok.BorderColor3 = self.Library.OutlineColor
		ok.BorderSizePixel = 1
		ok.Text = 'Confirm'
		ok.TextColor3 = self.Library.FontColor
