...
local SaveManager = {} do
	...
	function SaveManager:BuildFolderTree()
		-- Create parents first (Zee then Zee/Configs). Leaf-first breaks some executors.
	...
	function SaveManager:Save(name)
		...
		local data = { objects = {} }
		local toggles = rawget(getgenv(), 'Toggles') or Toggles
		local options = rawget(getgenv(), 'Options') or Options
