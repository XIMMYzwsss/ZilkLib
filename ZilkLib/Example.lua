...
local StyleBox = Tab3:AddRightGroupbox('Visual Styles')
StyleBox:AddLabel('Accent colored label text:', true)
local accentText = StyleBox:AddLabel('Updates with your theme accent')
accentText.TextLabel.TextColor3 = Library.AccentColor
Library:AddToRegistry(accentText.TextLabel, { TextColor3 = 'AccentColor' })
StyleBox:AddDivider()
StyleBox:AddLabel('Risky toggle style uses red text:')
StyleBox:AddToggle('Style_RiskyDemo', {
	Text = 'Risky toggle',
	Risky = true,
	Default = false,
})
StyleBox:AddLabel('Change accent in Settings > Themes', true)
