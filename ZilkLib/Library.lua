...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        Library:AddToRegistry(ToggleTrack, {
            BackgroundColor3 = Toggle.Value and 'AccentColor' or 'ToggleOffColor';
        });
        ...
        function Toggle:Display()
            ...
            if Library.RegistryMap[ToggleTrack] then
                Library.RegistryMap[ToggleTrack].Properties.BackgroundColor3 = Toggle.Value and 'AccentColor' or 'ToggleOffColor';
            end
        end;
...
function Library:CreateWindow(...)
    ...
    function Window:SetTabPosition(pos)
        ...
        if pos == 'Topbar' then
            ...
            TabArea.Size = UDim2.new(1, -16, 0, 36);
            ...
            TabContainer.Position = UDim2.new(0, 8, 0, TAB_TOP + 40);
            TabContainer.Size = UDim2.new(1, -16, 1, -(TAB_TOP + 48));
