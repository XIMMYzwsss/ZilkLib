...
function Library:CreateWindow(...)
    ...
    function Library:Toggle()
        ...
        -- Modal unlocks mouse at engine level (safe on PlayerGui; avoid CoreGui path).
        ...
        if self._MenuToggled then
            ...
            if IS_RIVALS then
                -- One-shot unlock only. Do NOT fight CameraController every frame / require it (hard-locks).
                pcall(function()
