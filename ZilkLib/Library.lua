...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        local ToggleTrack = Library:Create('TextButton', {
            BackgroundColor3 = Toggle.Value and Library.AccentColor or Color3.fromRGB(30, 30, 30);
            BorderSizePixel = 0;
        ...
        local ToggleKnob = Library:Create('Frame', {
            BackgroundColor3 = Toggle.Value and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(240, 240, 240);
            BorderSizePixel = 0;
        ...
        function Toggle:Display()
            ToggleTrack.BackgroundColor3 = Toggle.Value and Library.AccentColor or Color3.fromRGB(30, 30, 30);
            ToggleKnob.Position = UDim2.new(Toggle.Value and 1 or 0, Toggle.Value and -16 or 2, 0.5, -7);
            ToggleKnob.BackgroundColor3 = Toggle.Value and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(240, 240, 240);
        end;
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        function Dropdown:BuildDropdownList()
            ...
            if Dropdown._lazyScrollConnection then
                Dropdown._lazyScrollConnection:Disconnect();
                Dropdown._lazyScrollConnection = nil;
            end;
            if Dropdown._lazyOpenConnection then
                Dropdown._lazyOpenConnection:Disconnect();
                Dropdown._lazyOpenConnection = nil;
            end;
            ...
            if lazyLoadEnabled then
                ...
                Dropdown._lazyScrollConnection = Scrolling:GetPropertyChangedSignal('CanvasPosition'):Connect(function()
                ...
                Dropdown._lazyOpenConnection = ListOuter:GetPropertyChangedSignal('Visible'):Connect(function()
